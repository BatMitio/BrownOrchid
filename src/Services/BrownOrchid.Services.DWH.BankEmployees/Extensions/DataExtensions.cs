using BrownOrchid.Services.DWH.BankEmployees.Data.Persistence;
...
public static class DataExtensions
{
    public static void AddPersistence(this WebApplicationBuilder builder, string name = "Database")
    {
        ...
        builder.Services.AddDbContext<BankEmployeeDbContext>(opt =>
    ...
    public static void EnsureDatabaseCreated(this WebApplication app)
    {
        ...
        var db = scope.ServiceProvider.GetService<BankEmployeeDbContext>();
